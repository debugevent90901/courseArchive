...
struct vertex_t {
    ...
    int32_t is_reached;    // whether this vertex has been reached in dijkstra method   
};
...
extern void insert (graph_t *g, heap_t* h, int32_t new_elt);

// pop the top element of the heap and delete it
extern int32_t pop (graph_t* g, heap_t* h);
